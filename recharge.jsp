  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><a href="mobile.jsp">
		<img src="images/mobile.png" class="img-responsive" style="width:60%" alt="Image"></div>
        <div class="panel-footer">Mobile and DTH Recharge</div></a>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        <div class="panel-heading">DTH Recharge</div>
        <div class="panel-body"><a href="dth.jsp">
		<img src="images/dthicon.png" class="img-responsive" style="width:60%" alt="Image"></div>
